...
return [
    ...
    'exception_handle'       => 'app\\common\\SecurityExceptionHandle',
    ...
    'session'                => [
        ...
        // 是否自动开启 SESSION
        'auto_start'     => true,
        // 会话过期时间（秒），0表示浏览器关闭时过期
        'expire'         => 0,
        // 会话安全选项（TP5不支持samesite，由common_security通过ini_set处理）
        'secure'         => false,
        'httponly'       => 'true',
        'use_trans_sid'  => 0,
    ],
    ...
    'cookie'                 => [
        ...
        // cookie 有效域名
        'domain'    => '',
        //  cookie 启用安全传输（生产环境建议设为 true 配合 HTTPS）
        'secure'    => false,
        // httponly设置，防止XSS窃取Cookie
        'httponly'  => true,
        // 是否使用 setcookie
        'setcookie' => true,
    ],
